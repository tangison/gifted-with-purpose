...
export const metadata = {
  title: 'Make Your Own',
  description:
    'Build your gift in three steps: pick the item, pick a design or ask us to create one, add the name. Sends straight to WhatsApp with the price written out. Windhoek, Namibia.',
...
export default async function CreatePage({ searchParams }) {
  ...
  const howto = {
    ...
    step: [
      ...
      { '@type': 'HowToStep', position: 2, name: 'Pick the design', text: `Choose one of ${designs.length} ready-made designs, or describe a custom one for us to create.` },
      ...
      <section className="cblock cblock-tight" style={{ '--accent-ink': '#8A5A05' }}>
        <div className="wrap">
          ...
          <div className="cb-head">
            <p className="sub">Ready-made or created for you</p>
            <h1>Make your own</h1>
            <p>
