...
import { blanks, designs, work, blankPriceLabel, money } from '@/lib/catalog';
...
export const metadata = {
  ...
  openGraph: {
    title: 'How We Make It | Gifted with Purpose',
...
const STEPS = [
  {
    n: 1,
    name: 'You choose',
    text: 'Pick the item and the design on the website, or just send us a photo of what you have in mind. The item sets the price. Choosing a different design costs nothing.',
    detail: `${blanks.length} items, ${designs.length} ready-made designs, or something drawn from scratch.`,
  },
  {
    n: 2,
    name: 'We confirm',
    text: 'Geneveve replies on WhatsApp with the price, the spelling of any name, and how long it will take. Nothing is made until you say yes to what is written.',
...
export default function ProcessPage() {
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'How we make it', item: `${SITE_URL}/process` },
    ],
  };
  ...
  const faq = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'The item sets the price. A mug starts at N$120 and a sippy cup is N$230. Choosing a different ready-made design does not change the price. Custom artwork is quoted separately.',
        },
      },
      {
        '@type': 'Question',
    ...
    <main id="main">
      ...
      <section className="cblock cblock-tight" style={{ '--accent-ink': '#1F6F66' }}>
        <div className="wrap">
          <nav className="crumbs" aria-label="Breadcrumb">
            <Link href="/">Home</Link>
            <Chev />
            <span aria-current="page">How we make it</span>
          </nav>
      ...
      <section className="sec sec-alt">
        <div className="wrap">
          ...
          <p className="dp-lead">
            The item sets the price. Every one of the {designs.length} ready-made designs costs the same on the same
            item, so you are choosing on taste rather than on budget.
          </p>
          <div className="fits">
            {blanks.map((b) => (
