    ...
    <main id="main">
      ...
      <section className="sec sec-alt">
        <div className="wrap">
          ...
          <p className="disclaim" style={{ marginTop: 'var(--s-5)' }}>
            Every photograph on this page is our own work, taken in Windhoek. Some pieces were printed with characters
            or brands owned by other people at a customer&rsquo;s request. Gifted with Purpose is an independent print
            studio and is not affiliated with, endorsed by or connected to any of those rights holders.
          </p>
        </div>
      </section>
    </main>
