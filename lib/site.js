 ...
 * Canonical origin.
 *
 * giftedwithpurpose.net is the production domain. Every canonical tag,
...
export const IS_PRODUCTION_HOST = SITE_URL === 'https://giftedwithpurpose.net';
